...
/*    */   implements Function
/*    */ {
/* 26 */   public static final BitLength instance = new BitLength();
/*    */   
...
/*    */     }
/*    */     
/* 41 */     if (param0Value instanceof String) {
/* 42 */       return Integer.valueOf((((String)param0Value).getBytes()).length * 8);
/*    */     }
...
/* Location:              D:\projects\decompile\txc-client-4.0.5-release\!\com\tranboot\client\druid\sql\visitor\functions\BitLength.class
