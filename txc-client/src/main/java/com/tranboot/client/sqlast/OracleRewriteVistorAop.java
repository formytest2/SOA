...
public class OracleRewriteVistorAop extends OracleExportParameterVisitor {
    private SQLASTVisitorAspect aspect;
    private int point = 0;

    public OracleRewriteVistorAop(List<Object> args, StringBuilder sbuilder, SQLASTVisitorAspect aspect) {
    ...
    public OracleRewriteVistorAop(SQLASTVisitorAspect aspect) {
