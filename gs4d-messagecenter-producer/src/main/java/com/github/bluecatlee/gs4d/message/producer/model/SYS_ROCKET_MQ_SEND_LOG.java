...
public class SYS_ROCKET_MQ_SEND_LOG implements Serializable {
    ...
    private Date CONSUMER_SUCCESS_TIME;
    private String NEXT_RETRY_INTERVAL;
    private String HAS_LOG = "Y";
    ...
    public void setCONSUMER_SUCCESS_TIME(Date CONSUMER_SUCCESS_TIME) {
        this.CONSUMER_SUCCESS_TIME = CONSUMER_SUCCESS_TIME;
    }

    public Date getCONSUMER_SUCCESS_TIME() {
