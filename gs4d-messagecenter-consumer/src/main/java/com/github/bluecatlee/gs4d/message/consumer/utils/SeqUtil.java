...
public class SeqUtil {
    ...
    public static final String EX_ARC_DOC_SYSTEM_ID = "ex_arc_doc_system_id";
    public static final String PLATFORM_MQ_DUBBO_CONSUMER_SERIES = "platform_mq_dubbo_consumer_series";
    public static final String PLATFORM_MQ_HTTP_CONSUMER_SERIES = "platform_mq_http_consumer_series";
    public static final String SYS_ROCKET_MQ_CONSUMER_LOG_SERIES = "sys_rocket_mq_consumer_log_series";
