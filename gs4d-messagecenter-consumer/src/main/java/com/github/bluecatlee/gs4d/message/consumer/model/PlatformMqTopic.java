...
public class PlatformMqTopic {
    ...
    public void setCONSUMER_PULL_DELAY(Long CONSUMER_PULL_DELAY) {
        this.CONSUMER_PULL_DELAY = CONSUMER_PULL_DELAY;
    }
}
